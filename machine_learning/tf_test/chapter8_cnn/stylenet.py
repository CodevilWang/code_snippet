...
style_image = scipy.misc.imresize(style_image, (target_shape[0], target_shape[1])) # / style_image.shape[1])

vgg_layers = ['conv1_1', 'relu1_1',
        'conv1_2', 'relu1_2', 'pool1', 
        'conv2_1', 'relu2_1',
        'conv2_2', 'relue2_2', 'pool2',
        'conv3_1', 'relu3_1',
        'conv3_2', 'relu3_2',
        'conv3_3', 'relu3_3',
...
loss = original_loss + total_variation_loss + style_loss
