#!/usr/bin/env python
# code from https://mp.weixin.qq.com/s/qndGMdeiFl08KdGpJ5AMZA
...
if __name__ == "__main__":
    ...
    parser.add_argument('-id', '--input_dir', type = str, nargs = '?', \
            default = './aclImdb/', help = 'input data directory')
    parser.add_argument('-ot', '--output_json', type = str, nargs = '?', \
            default = './aclImdb_word_index.json', \
