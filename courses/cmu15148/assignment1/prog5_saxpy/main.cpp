...
int main() {
    ...
    float scale = 2.f;
    // void* X_area = aligned_alloc(CACHE_LINE_SIZE, sizeof(float) * N);
    // void* Y_area = aligned_alloc(CACHE_LINE_SIZE, sizeof(float) * N);
    // void* res_area = aligned_alloc(CACHE_LINE_SIZE, sizeof(float) * N);
